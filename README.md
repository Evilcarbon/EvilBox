...
<!-- PERMANENT TYPING LINE 2 -->
<img src="https://readme-typing-svg.demolab.com?font=Share+Tech+Mono&size=15&duration=2500&pause=999999&repeat=false&color=00BCD4&center=true&vCenter=true&width=750&height=30&lines=Red+Team+%7C+Purple+Team+%7C+APT+Emulation+%7C+Adversary+Simulation+%7C+Defensive+Validation" alt="capabilities" />

<br/>

<!-- BADGE ROW 1 — IDENTITY -->
![Version](https://img.shields.io/badge/VERSION-v2.0%20STABLE-e53935?style=for-the-badge&labelColor=0d1117&logo=buffer&logoColor=e53935)
![Codename](https://img.shields.io/badge/CODENAME-EVL--2026-7f1c1c?style=for-the-badge&labelColor=0d1117)
![License](https://img.shields.io/badge/LICENSE-PROPRIETARY-black?style=for-the-badge&labelColor=0d1117)
![Access](https://img.shields.io/badge/ACCESS-VERIFIED%20ONLY-e53935?style=for-the-badge&labelColor=0d1117&logo=shield&logoColor=white)

<!-- BADGE ROW 2 — PLATFORM -->
![Windows](https://img.shields.io/badge/Windows-0078D6?style=for-the-badge&logo=windows&logoColor=white)
![Linux](https://img.shields.io/badge/Linux-FCC624?style=for-the-badge&logo=linux&logoColor=black)
![macOS](https://img.shields.io/badge/macOS-000000?style=for-the-badge&logo=apple&logoColor=white)
![Deploy](https://img.shields.io/badge/DEPLOYMENT-Self--Hosted-586069?style=for-the-badge&labelColor=0d1117)

<!-- BADGE ROW 3 — CORE BACKEND STACK -->
...
<!-- BADGE ROW 4 — FRONTEND & WEB STACK -->
...
<!-- DIVIDER -->
<img src="https://capsule-render.vercel.app/api?type=rect&color=e53935&height=2&width=60%25" width="60%"/>
...
| | | |
|:---:|:---:|:---:|
| [Overview](#overview) | [Built For](#built-for) | [Tech Stack](#technology-stack) |
| [Architecture](#platform-architecture) | [Feature Modules](#feature-modules) | [Built-in Paid Tools](#built-in-paid-tools) |
| [Platforms & Binaries](#supported-platforms--binaries) | [Infrastructure Requirements](#infrastructure-requirements) | [System Requirements](#system-requirements) |
| [Installation](#installation) | [First-Time Setup](#first-time-setup) | [Setup Wizard](#setup-wizard) |
| [Email Server Setup](#email-server-setup) | [Updates](#automatic-updates) | [Distribution](#distribution-model) |
| [Access & Verification](#access--verification) | [License Terms](#license-terms) | [Pricing & Payment](#pricing--payment) |
| [Bug Reports & Feature Requests](#bug-reports--feature-requests) | [Contact & Support](#contact--support) | |
...
| Language | Role |
|:---:|:---|
| ![Go](https://img.shields.io/badge/Go-00ADD8?style=flat-square&logo=go&logoColor=white) **Go** | C2 server core, agent framework, concurrency engine, network I/O, REST API layer |
| ![C](https://img.shields.io/badge/C-A8B9CC?style=flat-square&logo=c&logoColor=black) **C** | Low-level agents, memory manipulation, OS interaction, kernel-level modules |
| ![C++](https://img.shields.io/badge/C%2B%2B-00599C?style=flat-square&logo=cplusplus&logoColor=white) **C++** | Native endpoint modules, Windows API integration, compiled agent components |
| ![Python](https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white) **Python** | Deepfake engine, OSINT automation, email intelligence pipelines, exploit scripting |
| ![Rust](https://img.shields.io/badge/Rust-000000?style=flat-square&logo=rust&logoColor=white) **Rust** | High-performance port scanning, binary tooling, memory-safe networking modules |
| ![Shell](https://img.shields.io/badge/Shell-121011?style=flat-square&logo=gnu-bash&logoColor=white) **Shell / Bash** | Automated infrastructure provisioning, server hardening, deployment scripts |

### Web GUI (localhost interface)

| Language / Framework | Role |
|:---:|:---|
| ![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white) **TypeScript** | Primary frontend language — type-safe UI logic across all dashboard modules |
| ![React](https://img.shields.io/badge/React-20232A?style=flat-square&logo=react&logoColor=61DAFB) **React** | Component-based web GUI — dashboards, campaign views, module panels |
| ![Tailwind](https://img.shields.io/badge/Tailwind_CSS-06B6D4?style=flat-square&logo=tailwindcss&logoColor=white) **Tailwind CSS** | Utility-first styling for the operator interface |
| ![JavaScript](https://img.shields.io/badge/JavaScript-F7DF1E?style=flat-square&logo=javascript&logoColor=black) **JavaScript** | Client-side logic, real-time WebSocket communications, dynamic UI components |
| ![HTML5](https://img.shields.io/badge/HTML5-E34F26?style=flat-square&logo=html5&logoColor=white) **HTML5** | Markup foundation for the web command center and MalPage Studio templates |

### Data & Infrastructure

| Technology | Role |
|:---:|:---|
| ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white) **PostgreSQL** | Primary relational database — campaigns, targets, credentials, evidence |
| ![SQLite](https://img.shields.io/badge/SQLite-003B57?style=flat-square&logo=sqlite&logoColor=white) **SQLite** | Lightweight local storage for agent configuration and offline operation |
| ![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat-square&logo=docker&logoColor=white) **Docker** | Container orchestration for modular service deployment |
| ![Nginx](https://img.shields.io/badge/Nginx-009639?style=flat-square&logo=nginx&logoColor=white) **Nginx** | Reverse proxy, SSL termination, and local web server for the GUI |
...
<div align="center">
<img src="https://readme-typing-svg.demolab.com?font=Share+Tech+Mono&size=13&duration=2000&pause=999999&repeat=false&color=00BCD4&center=true&vCenter=true&width=650&height=28&lines=%5B+%2B+%5D+13+operational+modules+active+and+ready" alt="modules active" />
</div>
...
<details>
<summary><b>Expand — Full Intelligence Capabilities</b></summary>

<br/>

**Built-in Paid Reconnaissance & Email Intelligence Tools**

EVILBOX ships with integrations for premium commercial intelligence platforms — no separate subscriptions or API key management required. The tool integrates via **official APIs and unofficial methods (scraping)** depending on the platform. See the [Built-in Paid Tools](#built-in-paid-tools) section for the full list.
...
<details>
<summary><b>Expand — Email Security Assessment & Intelligence Capabilities</b></summary>
...
<details>
<summary><b>Expand — Automated C2 Infrastructure Provisioning</b></summary>
...
<details>
<summary><b>Expand — Business Email Compromise & Email Attack Capabilities</b></summary>
...
<details>
<summary><b>Expand — Cross-Platform Covert Remote Desktop Management</b></summary>
...
<details>
<summary><b>Expand — Real-Time Deepfake for Social Engineering Exercises</b></summary>

<br/>

EVILBOX includes a **Live Video Deepfake Engine** purpose-built for authorized social engineering simulation and security awareness testing. This module requires a **dedicated GPU server** — see [Infrastructure Requirements](#infrastructure-requirements) for hardware specifications.
...
> **GPU Requirement:** The Deepfake Engine requires a dedicated GPU with sufficient VRAM to run real-time inference. Minimum 32 GB VRAM; 64 GB VRAM recommended for optimal performance. See [Infrastructure Requirements](#infrastructure-requirements).
...
<details>
<summary><b>Expand — Payload Forge, Evasion Lab & MalPage Studio</b></summary>
...
<details>
<summary><b>Expand — Campaign Command & Analytics</b></summary>
...
<details>
<summary><b>Expand — Endpoint Management, Lateral Movement & Exfiltration</b></summary>
...
<details>
<summary><b>Expand — Credential Vault, Evidence & Logs</b></summary>
...
<details>
<summary><b>Expand — Dashboards, Findings & Compliance</b></summary>
...
<details>
<summary><b>Expand — AI Features</b></summary>
...
![Debian](https://img.shields.io/badge/Debian%20%2F%20Ubuntu-A81D33?style=for-the-badge&logo=debian&logoColor=white)
![macOS](https://img.shields.io/badge/macOS%20Intel%20%2F%20Apple%20Silicon-000000?style=for-the-badge&logo=apple&logoColor=white)
...
> For GPU (Deepfake) and VPS (C2/Mail) requirements, see [Infrastructure Requirements](#infrastructure-requirements).
...
<details>
<summary><b>Expand — Full Setup Wizard Coverage</b></summary>
...
![Closed Source](https://img.shields.io/badge/Source-CLOSED%20SOURCE-e53935?style=for-the-badge&labelColor=0d1117)
![Binary Only](https://img.shields.io/badge/Distribution-BINARY%20ONLY-7f1c1c?style=for-the-badge&labelColor=0d1117)
![Encrypted](https://img.shields.io/badge/Archive-PASSWORD%20PROTECTED-00bcd4?style=for-the-badge&labelColor=0d1117)
...
<img src="https://readme-typing-svg.demolab.com?font=Share+Tech+Mono&weight=700&size=18&duration=2500&pause=999999&repeat=false&color=00BCD4&center=true&vCenter=true&width=620&height=40&lines=Lifetime+License+%E2%80%94+%242%2C000+USD+%7C+One-time+payment" alt="pricing" />
...
> **Wallet addresses are provided directly by @quantumcoders on Telegram at the time of purchase.**
> Do not send payment to any address found outside of a direct, verified conversation with the official account.
> **@quantumcoders is the only authorized point of sale for EVILBOX.**
...
1. Open a [GitHub Issue](../../issues/new/choose) in this repository
...
> All issues are reviewed and attended to as soon as possible.
> For urgent or security-critical bugs, contact **@quantumcoders** directly on Telegram.
> Do not open issues containing extraction passwords, license keys, or any sensitive credential material.
...
<img src="https://readme-typing-svg.demolab.com?font=Share+Tech+Mono&weight=700&size=19&duration=2500&pause=999999&repeat=false&color=FFFFFF&center=true&vCenter=true&width=700&height=45&lines=Official+access%2C+support+%26+purchases+via+Telegram" alt="support" />

[![Telegram](https://img.shields.io/badge/Telegram-%40quantumcoders-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/quantumcoders)
...
<!-- FOOTER WAVE -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=140&section=footer&text=QUANTUMCODERS%20%C2%A9%202026&fontSize=18&fontColor=ffffff&fontAlignY=75&stroke=e53935&strokeWidth=1" width="100%"/>

![Version](https://img.shields.io/badge/EVILBOX-v2.0-e53935?style=flat-square&labelColor=0d1117)
![Codename](https://img.shields.io/badge/EVLB---7f1c1c?style=flat-square&labelColor=0d1117)
![QuantumCoders](https://img.shields.io/badge/QuantumCoders-2026-000000?style=flat-square&labelColor=0d1117)
